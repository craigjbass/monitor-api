describe LocalAuthority::UseCase::SendReturnSubmissionNotification do
  ...
  context 'calls the email notification gateway' do
    example 'example 1' do
      use_case.execute(email: 'cat@cathouse.com', url: 'example.com', by: 'cat', project_name: 'flap')
    ...
    example 'example 2' do
      use_case.execute(email: 'dog@doghouse.com', url: 'example.net', by: 'dog', project_name: 'kennel')
