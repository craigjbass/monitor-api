...
describe 'Validates HIF return' do
  ...
  context 'Invalid HIF return' do
    ...
    it 'should return invalid if fails validation' do
      ...
      expect(valid_return[:pretty_invalid_paths]).to eq([['Infrastructures', 'Infrastructure 0', 'Planning', 'Outline Planning', 'Planning Permission Submitted', 'Percent Complete']])
    end
  end
end
